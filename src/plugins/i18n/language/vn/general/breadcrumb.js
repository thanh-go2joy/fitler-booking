export default {
  ...
  hotelDebtCreatePaid: 'Tạo thanh toán',
  ...
  mpBoostingEdit: 'Sửa chương trình ĐT',
  luckyWheel: 'Vòng xoay may mắn',
  referral: 'Chương trình giới thiệu',
  createEditLuckyWheel: 'Thêm, sửa vòng xoay may mắn',
  createEditReferral: 'Thêm/Sửa chương trình giới thiệu',
  referralReport: 'Referral report',
  referralDetail: 'Chi tiết referral',
  bookingReportTransfer: 'Chuyển đổi',
  title: 'Tiêu đề'
}
