export default {
  choose_display_in_app_web: 'Chọn hiển thị trên App/Web/Hotel Admin',
  title: 'Tiêu đề',
  image: 'Hình ảnh',
  ...
  displaySystem: 'Hệ thống hiển thị',
  random: 'Ngẫu nhiên',
  custom: 'Tùy chỉnh',
  // Validation
  ...
  requiredDisplayArea: 'Vui lòng chon khu vực hiển thị',
  requiredImagePath: 'Vui lòng chọn hình ảnh',
  requiredImageBanner: 'Vui lòng chọn hình ảnh'
}
